...
--
-- Host: 127.0.0.1
-- Tempo de geração: 10/10/2024 às 02:38
...
--
-- Estrutura para tabela `orderdetails`
--
...
--
-- Despejando dados para a tabela `orderdetails`
--
...
(10207, '2003-12-09', '2003-12-17', '2004-01-05', 'Shipped', 'Check on availability.', 495),
...
--
-- Estrutura para tabela `productlines`
--
...
--
-- Despejando dados para a tabela `productlines`
--
...
--
-- Índices de tabela `orderdetails`
--
...
--
-- Índices de tabela `productlines`
--
...
--
-- Restrições para tabelas `orderdetails`
--
ALTER TABLE `orderdetails`
